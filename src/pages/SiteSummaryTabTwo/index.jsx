...
import SiteSummaryTabTwoRadiobutton from "components/SiteSummaryTabTwoRadiobutton";

const SiteSummaryTabTwoPage = () => {
  const sideBarMenu = [
    {
      icon: (
        <Img
  ...
  return (
    <>
      <div className="bg-gray-50_02 flex font-roboto h-[1024px] justify-end mx-auto relative w-full">
        <div className="flex flex-col gap-[30px] h-full items-start justify-start mb-[87px] ml-auto mr-[70px] mt-auto md:px-5 w-3/4">
          ...
          <div className="bg-white-A700 flex flex-col items-center justify-end p-[29px] sm:px-5 rounded-lg shadow-bs7 w-full">
            <div className="flex flex-col justify-start mt-2 w-[99%] md:w-full">
              ...
              <div className="flex md:flex-col flex-row gap-[15px] items-center justify-between mt-[13px] w-full">
                ...
                <div className="bg-white-A700 flex md:flex-1 flex-col items-start justify-end p-2.5 rounded-[12px] w-[13%] md:w-full">
                  <SiteSummaryTabTwoRadiobutton className="flex flex-row gap-[23.46px] items-center justify-center md:ml-[0] ml-[3px] mt-0.5 w-auto" />
                </div>
              ...
              <div className="flex md:flex-col flex-row gap-14 items-center justify-start md:ml-[0] ml-[148px] mt-[34px] w-[65%] md:w-full">
                <div className="flex flex-row gap-[15px] items-center justify-between w-[46%] md:w-full">
                  <Text
                    className="text-black-900 text-lg"
                    size="txtRobotoRomanRegular18"
                  >
                  ...
                  <div className="bg-white-A700 border border-gray-300 border-solid flex flex-col items-center justify-end p-[9px] rounded-lg shadow-bs1 sm:w-full">
                    <Input
                      name="inputfieldtext_Six"
                      placeholder="Enter"
                      className="p-0 placeholder:text-gray-500 text-gray-500 text-left text-xs w-full"
                      wrapClassName="mt-0.5 w-[87%]"
                      size="xs"
                    ></Input>
                  </div>
                </div>
                <div className="flex flex-row gap-[37px] items-center justify-between w-[46%] md:w-full">
                  <Text
                    className="text-black-900 text-lg"
                    size="txtRobotoRomanRegular18"
                  >
...
export default SiteSummaryTabTwoPage;

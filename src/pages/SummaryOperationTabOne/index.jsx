...
import SummaryOperationTabOneRowrectanglefive from "components/SummaryOperationTabOneRowrectanglefive";
...
const SummaryOperationTabOnePage = () => {
    ...
    },
    {
      ...
      label: (
        <>
          ...
          <Text className="capitalize w-auto">Summary Operations</Text>
        </>
      ),
    },
  ];
  ...
  return (
    <>
      <div className="bg-gray-50_02 font-roboto h-[1024px] mx-auto relative w-full">
        <div className="bg-white-A700 border border-solid flex flex-col gap-[19px] h-full justify-center ml-auto mr-[51px] mt-[140px] md:px-5 rounded-lg shadow-bs7 w-3/4 yellow_700_d8_cyan_A200_border">
          <div className="flex flex-col gap-5 items-start justify-start md:ml-[0] ml-[49px] mr-[758px] mt-9 w-[26%] md:w-full">
              ...
              <div className="flex flex-1 flex-col items-center justify-start my-0 w-full">
                <div className="flex flex-col gap-[9px] items-center justify-start w-full">
                  ...
                  <div className="flex md:flex-col flex-row md:gap-5 items-start justify-start w-[93%] md:w-full">
                    ...
                    <Text
                      className="ml-14 md:ml-[0] md:mt-0 mt-1 text-gray-600 text-sm"
                    ...
                    <Text
                      className="md:ml-[0] ml-[134px] md:mt-0 mt-[5px] text-gray-600 text-sm"
                      size="txtRobotoRomanRegular14"
                    >
                      1
                    </Text>
                    ...
                    <Text
                      className="md:ml-[0] ml-[125px] md:mt-0 mt-[5px] text-gray-600 text-sm"
                      size="txtRobotoRomanRegular14"
                    >
                      0
                    </Text>
                    <Text
                      className="md:ml-[0] ml-[121px] md:mt-0 mt-[5px] text-gray-600 text-sm"
                      size="txtRobotoRomanRegular14"
                    >
                      64%
                    </Text>
        ...
        <div className="absolute flex flex-col inset-[0] justify-center m-auto md:px-5 w-full">
          ...
          >
            <Img
              className="h-[132px] md:h-auto md:ml-[0] mt-[9px] mx-[61px] object-cover w-[132px]"
              src="images/img_teslalogo1.png"
              alt="teslalogoOne"
            />
            <Menu
              menuItemStyles={{
              ...
              className="flex flex-col items-center justify-start pt-[18px] px-3 w-[91%]"
            >
              ...
              <SummaryOperationTabOneRowrectanglefive className="bg-orange-300 flex flex-row items-center justify-start rounded" />
            </Menu>
            {!collapsed && (
...
export default SummaryOperationTabOnePage;

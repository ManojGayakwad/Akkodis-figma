    ...
    },
    {
      icon: (
        <Img
          ...
          src="images/img_close_25x26.svg"
          alt="close"
        />
      ),
      label: "Site Summary ",
    ...
    <>
      <div className="bg-gray-50_02 font-roboto h-[1024px] mx-auto relative w-full">
        ...
        <div className="absolute flex flex-col inset-[0] justify-center m-auto md:px-5 w-full">
          ...
          >
            <Img
              className="h-14 md:ml-[0] mt-[9px] mx-[29px] w-[196px]"
            ...
            <Menu
              menuItemStyles={{
                button: {
                  ...
                  borderRadius: "4px",
                  [`&:hover, &.ps-active`]: {
                    backgroundColor: "#ffc649ff !important",
                  },
                },
              }}
              className="flex flex-col items-center justify-start mt-16 pt-[18px] px-3 w-[91%]"
            >
...
export default SummaryOperationTabPage;
